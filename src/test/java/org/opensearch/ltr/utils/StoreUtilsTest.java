...
public class StoreUtilsTest extends OpenSearchIntegTestCase {
    ...
    @Test(expected = IndexNotFoundException.class)
    public void getFeatureSets_IndexNotExist() {
        storeUtils.getFeatureSets("non-existent");
    }
    ...
    public void getFeatureSets() {
        ...
        Map<String, Integer> featureset = storeUtils.getFeatureSets(IndexFeatureStore.DEFAULT_STORE);
