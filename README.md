...
| 2.7.0 | `bin/opensearch-plugin install https://github.com/gsingers/opensearch-learning-to-rank-base/releases/download/release-v2.7.0/opensearch-ltr-2.7.0.0.zip` |
| 2.8.0 | `bin/opensearch-plugin install https://github.com/gsingers/opensearch-learning-to-rank-base/releases/download/release-v2.8.0/opensearch-ltr-2.8.0.0.zip` |
| 2.9.0 | `bin/opensearch-plugin install https://github.com/gsingers/opensearch-learning-to-rank-base/releases/download/release-v2.9.0/opensearch-ltr-2.9.0.0.zip` |
